...
function TeDhenatEBiznesit(props) {
    ...
    async function handleRuaj(e) {
        ...
        if (foto) {
            ...
            try {
                await axios.post(`https://localhost:7156/api/VendosFotot/PerditesoTeDhenatBiznesit?logoVjeter=${teDhenatBiznesit.logo}`, formData, authentikimi)
                    .then(async (response) => {
                        axios.put("https://localhost:7156/api/TeDhenatBiznesit/perditesoTeDhenat", {
            ...
            await axios.put("https://localhost:7156/api/TeDhenatBiznesit/perditesoTeDhenat", {
                "emriIbiznesit": formValue.emriBiznesit,
                "shkurtesaEmritBiznesit": formValue.shkurtesaEmrit,
                "nui": formValue.nui,
                "nf": formValue.nf,
