...
function Checkout(props) {
            ...
            const vendosTeDhenat = async () => {
                try {
                    const perdoruesi = await axios.get(
                        `https://localhost:5289/api/Perdoruesi/shfaqSipasID?idUserAspNet=${getID}`, authentikimi
                    );
    ...
    const handlePerfundoPorosine = async () => {
        try {
            await axios
                .post("https://localhost:5289/api/Porosia/vendosPorosine", {
                ...
                .then((response) => {
                    ...
                    cart.forEach((produkti) => {
                        axios
                            .post("https://localhost:5289/api/Porosia/vendosTeDhenatPorosise", {
