...
function EditoKompanin(props) {
        ...
        const vendosKategorite = async () => {
            try {
                const kategorite = await axios.get(
                    `https://localhost:7156/api/Kategoria/shfaqKategorit`, authentikimi
                );
    ...
    useEffect(() => {
        const ShfaqKategorine = async () => {
            try {
                const kategoria = await axios.get(`https://localhost:7156/api/Kategoria/shfaqKategorinSipasIDs?id=${props.id}`, authentikimi);
    ...
    function handleSubmit() {
        axios.put(`https://localhost:7156/api/Kategoria/perditesoKategorin?id=${kategoria.kategoriaId}`, kategoria, authentikimi)
            .then(x => {
