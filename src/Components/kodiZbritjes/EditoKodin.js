...
function EditoKodin(props) {
    ...
    useEffect(() => {
        const shfaqKodin = async () => {
            try {
                const teDhenatKodit = await axios.get(`https://localhost:7156/api/KodiZbritje/gjejKodin?kodi=${props.id}`, authentikimi);
    ...
    function handleSubmit() {
        ...
        axios.put(`https://localhost:7156/api/KodiZbritje/perditesoTeDhenatEKodit?kodi=${kodi.kodi}`, kodi, authentikimi)
            .then(x => {
