...
function Statistika() {
    ...
    useEffect(() => {
        const vendosTotalinPerdoruesve = async () => {
            try {
                const totalet = await axios.get("https://localhost:7156/api/Statistikat/totaleTeNdryshme", authentikimi);
        ...
        const vendosTop15Bleresit = async () => {
            try {
                const bleresit = await axios.get("https://localhost:7156/api/Statistikat/15PerdoruesitMeSeShumtiBlerje", authentikimi);
        ...
        const vendosTop15Produktet = async () => {
            try {
                const produktet = await axios.get("https://localhost:7156/api/Statistikat/15ProduktetMeTeShitura", authentikimi);
        ...
        const vendosShitjetJavore = async () => {
            try {
                const dita = await axios.get("https://localhost:7156/api/Statistikat/TotaletJavore", authentikimi);
