        ...
        const vendosTeDhenat = async () => {
            try {
                ...
                const produktet = await axios.get(
                    `https://localhost:7156/api/RegjistrimiStokut/shfaqTeDhenatKalkulimit?idRegjistrimit=${props.id}`, authentikimi
                );
        ...
        const shfaqTeDhenatFature = async () => {
            try {
                ...
                const teDhenat = await axios.get(
                    `https://localhost:7156/api/RegjistrimiStokut/shfaqRegjistrimetNgaID?id=${props.id}`, authentikimi
                );
