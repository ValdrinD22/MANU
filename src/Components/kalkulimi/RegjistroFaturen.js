...
function RegjistroFaturen(props) {
        ...
        const vendosProduktet = async () => {
            try {
                const produktet = await axios.get(
                    `https://localhost:7156/api/Produkti/ProduktetPerKalkulim`, authentikimi
                );
    ...
    async function handleMbyllFature() {
        try {
            await axios.post('https://localhost:7156/api/RegjistrimiStokut/RuajKalkulimin', {
                ...
                for (let produkti of produktetNeKalkulim) {
                    await axios.post('https://localhost:7156/api/RegjistrimiStokut/ruajKalkulimin/teDhenat', {
                    ...
                    await axios.put(`https://localhost:7156/api/RegjistrimiStokut/ruajKalkulimin/perditesoStokunQmimin?id=${produkti.produktiId}`, {
