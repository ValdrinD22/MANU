            ...
            const vendosFature = async () => {
                try {
                    const fatura = await axios.get(
                        `https://localhost:7156/api/Porosia/shfaqPorosineNgaID?nrFatures=${nrFatures}`, authentikimi
                    );
        ...
        const vendosTeDhenatBiznesit = async () => {
            try {
                const teDhenat = await axios.get(
                    "https://localhost:7156/api/TeDhenatBiznesit/ShfaqTeDhenat", authentikimi
                );
