...
const SignUp = () => {
  ...
  async function CreateAcc(e) {
    ...
    if (
      ...
      const kontrolloEmail = await axios.get(`https://localhost:7156/api/Perdoruesi/KontrolloEmail?email=${email}`, authentikimi)
      ...
      if (kontrolloEmail.data === true) {
        ...
        axios
          .post("https://localhost:7156/api/Authenticate/register", {
            name: emri,
            lastName: mbimeri,
            email: email,
            username: username,
  ...
  return (
    <div className="sign-up">
      <Helmet>
        <title>Sign Up | ManU Store</title>
      </Helmet>
      <NavBar />
