...
{
    /// <inheritdoc />
    public partial class InsertimiTeDehnave : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                {
                    {
                        "9d6b2651-641d-4c85-9154-99761863fc65", "user", "USER", "user@manustore.com", "USER@manustore.COM",
                    ...
                    {
                        "d2a7088f-a25e-4f3f-8488-b616eeaff928", "menagjer", "MENAGJER", "menagjer@manustore.com", "MENAGJER@manustore.COM",
                        false, // EmailConfirmed
                    ...
                    {
                        "f2bb7622-23ac-4c5f-8d71-00032b281e37", "admin", "ADMIN", "admin@manustore.com", "ADMIN@manustore.COM",
                        false, // EmailConfirmed
...
{ "f2bb7622-23ac-4c5f-8d71-00032b281e37", "0267d4fd-5bac-4552-9930-8e528b2fec1b"}
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
            { 1, "Administrator", "Administrator", "admin@manustore.com", "admin", "f2bb7622-23ac-4c5f-8d71-00032b281e37" },
            { 2, "Menagjer", "Menagjer", "menagjer@manustore.com", "menagjer", "d2a7088f-a25e-4f3f-8488-b616eeaff928" },
            { 3, "User", "User", "user@manustore.com", "user", "9d6b2651-641d-4c85-9154-99761863fc65" }
                });
