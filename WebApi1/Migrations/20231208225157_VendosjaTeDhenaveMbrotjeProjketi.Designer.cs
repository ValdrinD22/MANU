...
{
    [DbContext(typeof(ManchesterUnitedDbContext))]
    [Migration("20231208225157_VendosjaTeDhenaveMbrotjeProjketi")]
    partial class VendosjaTeDhenaveMbrotjeProjketi
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApi1.Models.ContactForm", b =>
                {
            ...
            modelBuilder.Entity("WebApi1.Models.KategoriaProduktit", b =>
                {
            ...
            modelBuilder.Entity("WebApi1.Models.KodiZbritjes", b =>
                {
            ...
            modelBuilder.Entity("WebApi1.Models.Kompania", b =>
                {
            ...
            modelBuilder.Entity("WebApi1.Models.Perdoruesi", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApi1.Models.Porosit", b =>
                {
            ...
            modelBuilder.Entity("WebApi1.Models.Produkti", b =>
                {
            ...
            modelBuilder.Entity("WebApi1.Models.RegjistrimiStokut", b =>
                {
            ...
            modelBuilder.Entity("WebApi1.Models.StokuQmimiProduktit", b =>
                {
            ...
            modelBuilder.Entity("WebApi1.Models.TeDhenatBiznesit", b =>
                {
            ...
            modelBuilder.Entity("WebApi1.Models.TeDhenatEPorosis", b =>
                {
            ...
            modelBuilder.Entity("WebApi1.Models.TeDhenatPerdoruesit", b =>
                {
            ...
            modelBuilder.Entity("WebApi1.Models.TeDhenatRegjistrimit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApi1.Models.ZbritjaQmimitProduktit", b =>
                {
            ...
            modelBuilder.Entity("WebApi1.Models.ContactForm", b =>
                {
                    b.HasOne("WebApi1.Models.Perdoruesi", "User")
            ...
            modelBuilder.Entity("WebApi1.Models.KodiZbritjes", b =>
                {
                    b.HasOne("WebApi1.Models.Produkti", "Produkti")
            ...
            modelBuilder.Entity("WebApi1.Models.Porosit", b =>
                {
                    b.HasOne("WebApi1.Models.Perdoruesi", "Klienti")
                        .WithMany("Porosit")
            ...
            modelBuilder.Entity("WebApi1.Models.Produkti", b =>
                {
                    b.HasOne("WebApi1.Models.KategoriaProduktit", "Kategoria")
                        .WithMany("Produkti")
                        .HasForeignKey("KategoriaId");

                    b.HasOne("WebApi1.Models.Kompania", "Kompania")
                        .WithMany("Produkti")
            ...
            modelBuilder.Entity("WebApi1.Models.RegjistrimiStokut", b =>
                {
                    b.HasOne("WebApi1.Models.Perdoruesi", "Stafi")
            ...
            modelBuilder.Entity("WebApi1.Models.StokuQmimiProduktit", b =>
                {
                    b.HasOne("WebApi1.Models.Produkti", "Produkti")
                        ...
                        .HasForeignKey("WebApi1.Models.StokuQmimiProduktit", "ProduktiId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebApi1.Models.TeDhenatEPorosis", b =>
                {
                    b.HasOne("WebApi1.Models.Porosit", "Porosia")
            ...
            modelBuilder.Entity("WebApi1.Models.TeDhenatPerdoruesit", b =>
                {
                    b.HasOne("WebApi1.Models.Perdoruesi", "User")
                        ...
                        .HasForeignKey("WebApi1.Models.TeDhenatPerdoruesit", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebApi1.Models.TeDhenatRegjistrimit", b =>
                {
                    ...
                    b.HasOne("WebApi1.Models.RegjistrimiStokut", "Regjistrimi")
                        .WithMany("TeDhenatRegjistrimit")
            ...
            modelBuilder.Entity("WebApi1.Models.ZbritjaQmimitProduktit", b =>
                {
                    b.HasOne("WebApi1.Models.Produkti", "Produkti")
                        ...
                        .HasForeignKey("WebApi1.Models.ZbritjaQmimitProduktit", "ProduktiId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
