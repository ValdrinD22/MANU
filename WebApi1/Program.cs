...
builder.Services.AddDbContext<ManchesterUnitedDbContext>(opt => opt.UseSqlServer(builder.Configuration.GetConnectionString("Conn")));
...
builder.Services.AddIdentity<IdentityUser, IdentityRole>()
        .AddEntityFrameworkStores<ManchesterUnitedDbContext>()
